class Player {
  ...
  prettyTime(timeInSeconds) {
    ...
    const minuteString = minutes < 10 ? '0' + String(minutes) : String(minutes);
    const secondString = seconds < 10 ? '0' + String(seconds) : String(seconds);
    const prettifiedTime = minuteString + ':' + secondString;
